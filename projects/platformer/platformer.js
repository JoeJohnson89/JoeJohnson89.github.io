$(function () {
  ...
  function setup() {
    ...
    createPlatform(850, 500, 250, 20);
    createPlatform(450, 375, 250, 20);
    createPlatform(100, 300, 250, 20);
    ...
    createCollectable('grace', 400, 250);
    createCollectable('kennedi', 700, 100);
